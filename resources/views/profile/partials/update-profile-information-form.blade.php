<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="sim" :value="__('No SIM')" />
            <x-text-input id="sim" name="sim" type="text" class="mt-1 block w-full" :value="old('sim', $user->sim)" required autofocus autocomplete="sim" />
